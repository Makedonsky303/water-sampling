...
export const ICON_MAP = {
  ...
  ice_eutectic:        { icon: '🧊', label: 'Эвтектический хладоэлемент',               slot: null, maxStack: 10, unlimited: true },
  ice_gel:             { icon: '🫙', label: 'Гелевый хладоэлемент',                     slot: null, maxStack: 10, unlimited: true },
  ice_silicone:        { icon: '💧', label: 'Силиконовый хладоэлемент',                 slot: null, maxStack: 10, unlimited: true },
