...
function FaucetSVG({ aeratorRemoved, spotsLeft, isWiping, onRemoveAerator, onWipeSpot, glovesEquipped }) {
  ...
  return (
    <svg viewBox="0 0 600 560" xmlns="http://www.w3.org/2000/svg"
      ...
      <path d="M30 405 Q30 540 120 540 L480 540 Q570 540 570 405 L570 395 L30 395 Z" fill="url(#fc_sink)" stroke="#94a3b8" strokeWidth="2.5"/>
      ...
      <rect x="188" y="92"  width="80" height="28"  rx="14" fill="url(#fc_side)"   stroke="#94a3b8" strokeWidth="2"/>
      <circle cx="205" cy="106" r="13" fill="url(#fc_chrome)" stroke="#fca5a5" strokeWidth="1.5"/>
      <text x="205" y="111" textAnchor="middle" fontSize="11" fill="#ef4444" fontWeight="bold">H</text>
      <rect x="332" y="92"  width="80" height="28"  rx="14" fill="url(#fc_side)"   stroke="#94a3b8" strokeWidth="2"/>
      <circle cx="395" cy="106" r="13" fill="url(#fc_chrome)" stroke="#93c5fd" strokeWidth="1.5"/>
      ...
      {spotsLeft===0 && aeratorRemoved && [0,1,2].map(i=>(
        <ellipse key={i} cx={436+i*5} cy={372+i*18} rx="3.5" ry="6" fill="#bae6fd" opacity="0.7"
